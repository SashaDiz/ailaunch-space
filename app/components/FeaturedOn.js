// Server Component - ensures links are in initial HTML for bots/scrapers
  ...
  return (
    <section className="mt-8 sm:mt-16">
      ...
      <ul className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
        <li>
          <a href="https://launchigniter.com/product/ai-launch-space?ref=badge-ai-launch-space" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://auraplusplus.com/projects/ai-launch-space" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-2 bg-white rounded-lg p-2 border border-gray-200 hover:border-[#ED0D79] hover:scale-105 transition-transform duration-200">
        ...
        <li>
          <a href="https://fazier.com/launches/www.ailaunch.space" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-2 bg-white rounded-lg p-2 border border-gray-200 hover:border-[#ED0D79] hover:scale-105 transition-transform duration-200">
        ...
        <li>
          <a href="https://yo.directory/" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-2 bg-white rounded-lg p-2 border border-gray-200 hover:border-[#ED0D79] hover:scale-105 transition-transform duration-200">
        ...
        <li>
          <a href="https://launch-list.org/product/ai-launch-space" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-2 bg-white rounded-lg p-2 border border-gray-200 hover:border-[#ED0D79] hover:scale-105 transition-transform duration-200">
        ...
        <li>
          <a href="https://directoryhunt.org/?ref=ailaunch.space" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center justify-center gap-2 bg-white rounded-lg p-2 border border-gray-200 hover:border-[#ED0D79] hover:scale-105 transition-transform duration-200">

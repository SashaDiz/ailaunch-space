...
export async function generateMetadata() {
  return {
    ...
    description: `Terms and conditions for using ${siteConfig.name} platform and services.`,
  };
}
        ...
        <div className="prose max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              {siteConfig.name} is operated by Aleksandr Borisov, an individual entrepreneur registered in Georgia (Registration No. 011-90274).
            </p>

            <h2 className="text-2xl font-semibold mb-4">1. Agreement to Terms</h2>
            <p className="text-muted-foreground mb-4">
              By accessing and using {siteConfig.name} (&quot;the Platform&quot;), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              {siteConfig.name} is a discovery and launch platform connecting creators with early adopters. Inspired by Product Hunt and Uneed.best, it features a curated directory where entrepreneurs, developers, and makers showcase digital products, SaaS tools, and creative projects. Our services include:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              ...
              <a href={`mailto:${siteConfig.contact.supportEmail}`} className="text-primary underline-offset-4 hover:underline">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              The Platform and its original content, features, and functionality are owned by {siteConfig.name} and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              The Platform may contain links to third-party websites or services that are not owned or controlled by {siteConfig.name}. We have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party websites or services.
            </p>

            <h3 className="text-xl font-semibold mb-3">9.3 Limitation of Liability</h3>
            <p className="text-muted-foreground mb-4">
              In no event shall {siteConfig.name}, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your use of the Platform.
            </p>
          </section>

...
export const AppSchema = z.object({
  ...
  ratings_count: z.number().default(0),
  comments_count: z.number().default(0),
  bookmarks_count: z.number().default(0),

  // Ranking and Competition
  // Ranking fields — populated by cron jobs and competition lifecycle handlers
...
export const ProjectSubmissionSchema = z.object({
  ...
  // Launch week removed - no longer required
  launch_week: z.string().optional(),
...
// Competition Schema (deprecated - kept for backwards compatibility)
...
export const CompetitionSchema = z.object({
  ...
  // Limits
  // Standard Launch (FREE): 15 slots per week, nofollow by default
...
export const BacklinkSchema = z.object({
  ...
  // Link details
  source_url: z.string().url(), // Platform URL
